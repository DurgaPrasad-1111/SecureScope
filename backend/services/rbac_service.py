...
DEFAULT_PERMISSIONS = {
    ...
    "admin:request": "Request admin access",
    "admin:review": "Review admin access requests",
}

DEFAULT_ROLES = {
    "basic": {
        "description": "Passive scan access",
        "permissions": ["scan:passive", "scan:read", "admin:request"],
    },
    "authorized": {
        "description": "Passive and active scan access",
        "permissions": ["scan:passive", "scan:active", "scan:read", "admin:request"],
    },
    "admin": {
