...
class Config:
    ...
    SIGNUP_RATE_LIMIT = _to_int(os.getenv("SIGNUP_RATE_LIMIT"), default=5)
    SIGNUP_RATE_WINDOW_SEC = _to_int(os.getenv("SIGNUP_RATE_WINDOW_SEC"), default=300)
    ...
    SCAN_TIME_BUDGET_SECONDS = _to_int(os.getenv("SCAN_TIME_BUDGET_SECONDS"), default=55)
    SCAN_TOOL_TIMEOUT_SECONDS = _to_int(os.getenv("SCAN_TOOL_TIMEOUT_SECONDS"), default=20)
    SCAN_SUBDOMAIN_TOOL_TIMEOUT_SECONDS = _to_int(os.getenv("SCAN_SUBDOMAIN_TOOL_TIMEOUT_SECONDS"), default=10)
    SCAN_URL_DISCOVERY_TIMEOUT_SECONDS = _to_int(os.getenv("SCAN_URL_DISCOVERY_TIMEOUT_SECONDS"), default=15)
    SCAN_PORT_SCAN_TIMEOUT_SECONDS = _to_int(os.getenv("SCAN_PORT_SCAN_TIMEOUT_SECONDS"), default=15)
    SCAN_WHOIS_TIMEOUT_SECONDS = _to_int(os.getenv("SCAN_WHOIS_TIMEOUT_SECONDS"), default=5)

    ALLOW_SIGNUP = _to_bool(os.getenv("ALLOW_SIGNUP"), default=APP_ENV.lower() != "production")
    ...
    # One-time admin bootstrap token (required in production for /setup)
    ...
    ENABLE_TOTP = _to_bool(os.getenv("ENABLE_TOTP"), default=True)
    TOTP_ISSUER = os.getenv("TOTP_ISSUER", "ReconEngine")
